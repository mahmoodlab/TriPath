...
class SwinTransformer(nn.Module):
    ...
    def load_weights(self, load_weights=True, weights=None, **kwargs):
        if load_weights:
            ...
            if self.name == 'small':
                weights = Swin_V2_S_Weights.verify(Swin_V2_S_Weights.IMAGENET1K_V1)
            elif self.name == 'base':
                weights = Swin_V2_B_Weights.verify(Swin_V2_B_Weights.IMAGENET1K_V1)
            else:
...
def swin2d_s(*, weights: Optional[Swin_V2_S_Weights] = None, progress: bool = True, **kwargs: Any) -> SwinTransformer:
    """
...
def swin2d_b(*, weights: Optional[Swin_V2_B_Weights] = None, progress: bool = True, **kwargs: Any) -> SwinTransformer:
    """
